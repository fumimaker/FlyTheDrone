...
def headingRelative(headRel):
    ...
    '''nowDeg = math.degrees(vehicle.attitude.yaw)
    diff = abs(headRel - nowDeg)
    while diff - abs(nowDeg-math.degrees(vehicle.attitude.yaw)) > diff*0.95:
        print(math.degrees(vehicle.attitude.yaw))
        time.sleep(1)'''
    time.sleep(5)
    print("Yaw heading completed.")
